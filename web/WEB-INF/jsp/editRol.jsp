...
<html>
    ...
    <header class="labelbas"><b>Rol Güncelle</b></header>
    <%--style>
        .center {
            text-align: center;
        }
...
<body>
    ...
    <form:form method="POST" action="updateRol.html" commandName="Rol" >
        <input type="hidden" name="id" value="${r.id}"/>
        <table>
            <tr>
                <td><label class="label" for="roladi" ><b>Rol Adı :</b>  </label></td>
                <td><input type="text" name="roladi" value="${r.roladi}" id="roladi" class="textbox" style="height: 40px;width:200px"/></td>
            </tr>
            <tr>
                <td> <label class="label" for="aciklama"><b>Açıklama :</b>  </label></td>
                <td> <input type="text" name="aciklama" value="${r.aciklama}" id="aciklama" class="textbox" style="height: 40px;width:200px"/></td>
            </tr>
            <tr>
                <td><label class="label" for="aktifmi" ><b>Aktif Mi :&nbsp;&nbsp;&nbsp;</b></label></td>
                <td><form:checkbox path="aktifmi"></form:checkbox></td>
            </tr>
            <br/>
            <tr>
                                                    ...
                                                    <td width="50%">
                                                        ...
                                                        <select id="form_roles_u" name="form_roles_u" size="8" style="display: none;" style="width:100%;" multiple="multiple">
                                                            <c:forEach items="${rightList}" var="itemRight" varStatus="count"> 
                                                                <option value="${itemRight.altMenulerId}" >${itemRight.altMenuAdi}</option>
                                                            </c:forEach>
