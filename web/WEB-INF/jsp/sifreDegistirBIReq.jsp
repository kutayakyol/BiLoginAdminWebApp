...
<body>
    <form:form id="passForm" method="POST" action="updatepasswordreq.html" commandName="Kullanici" onsubmit="return checkAllPasswordRule();">
        ...
        <table cellpadding="2" cellspacing="2">
            ...
            <tr>
                <td>&nbsp;</td>
                <td><input id="subSave" type="submit" name="updatesifrereq" class="myButton" value="Şifre Değiştir..." style="height:35px;width:150px"/></td>
            </tr>
        </table>
        <br/><br/>
        <table>
            <tr>
                <td>
                    <span style="font-size: 1.3em;">
                        ...
                        <br/>
                        <br/>Varsayılan şifreniz ile giriş yaptığınız için yeni şifrenizi belirlemeniz gerekmektedir.
                        <font style="font-size: 1.0em;" color=#e60000><br/><b>OTURUMUNUZU SONLANDIRIP YENİ ŞİFRENİZLE </b>TEKRAR GİRİŞ YAPMALISINIZ.</font>
                    </span>
                </td>
            </tr>
        </table>
